...
ActiveRecord::Schema.define(version: 20180418130655) do
  ...
  create_table "task_lists", force: :cascade do |t|
    ...
    t.index ["user_id", "created_at"], name: "index_task_lists_on_user_id_and_created_at"
    t.index ["user_id", "title"], name: "index_task_lists_on_user_id_and_title", unique: true
